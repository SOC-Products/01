        ...
        <div className="overflow-hidden w-full h-[47vh] m-5">
          <div className="object-contain w-full h-[49vh] p-[16px]" >
            ...
            <span style={{ display: 'flex' }}>  <h2 style={{ color: 'white' }}>{t?.TitleMainTraditional}</h2>
              <h3 className="max-w-full uppercase styled-border m-auto lg:m-0 md:m-0 sm:m-0 uplift-element"><span className='target-span' style={{ padding: '10px 10px' }}>{t?.TitleMainWeb}<span style={{ color: '#E2255E' }}>{t?.TitleMain3}</span></span></h3>
            </span>
          </div>
        </div>
      </div>
