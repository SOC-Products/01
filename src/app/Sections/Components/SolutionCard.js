...
function SolutionCard({ solution, index }) {
  ...
  return (
    <div className="w-full flex flex-wrap border-[#061e5e] border-opacity-[0.3] border-t-2 border-l-2">
      ...
      <div className="flex-[.4] flex-col flex border-x-2 border-[#061e5e] border-opacity-[0.3] py-5 min-w-[300px]  mx-auto">
        
        {solution?.links?.map((e, i) => (
          <div
            key={i}
            className="text-right border-t-2 border-[#061e5e] border-opacity-[0.3] justify-end flex p-2"
          >
